...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        Activity.objects.create(user='Iron Man', activity_type='run', duration=30, date='2026-02-11')
        Activity.objects.create(user='Captain America', activity_type='cycle', duration=45, date='2026-02-10')
        Activity.objects.create(user='Batman', activity_type='swim', duration=25, date='2026-02-09')
        Activity.objects.create(user='Superman', activity_type='fly', duration=60, date='2026-02-08')
